...
# Particl
    ...
    "miner -> validation -> pos/miner -> miner"
    "node/blockstorage -> validation -> pos/miner -> node/blockstorage"
    "pos/kernel -> validation -> pos/miner -> pos/kernel"
    "pos/miner -> wallet/hdwallet -> validation -> pos/miner"
