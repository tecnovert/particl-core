...
class SettingsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by Particl Core. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
