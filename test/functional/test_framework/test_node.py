...
class TestNode():
    ...
    def __init__(self, i, datadir_path, *, chain, rpchost, timewait, timeout_factor, bitcoind, bitcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False, v2transport=False):
        ...
        self.bitcoinconf = self.datadir_path / "particl.conf"
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, env=None, **kwargs):
        ...
        if kwargs.pop('btcmode', True):
            extra_args.insert(0, '-btcmode')
            extra_args.insert(0, '-nosmsg')
    ...
    def setmocktime(self, timestamp, offset=False):
        ...
        return self.__getattr__('setmocktime')(timestamp, offset)
    ...
    def addmultisigaddress_part(self, nrequired, keys, label=None, bech32=False, large_key=False, address_type=None):
        if self.is_cli:
            ...
            if address_type is None:
                address_type = 'null'
        return self.__getattr__('addmultisigaddress')(nrequired, keys, label, bech32, large_key, address_type)
