...
from test_framework.key import generate_privkey, compute_xonly_pubkey, tweak_add_pubkey
...
class ParticlTaprootTest(ParticlTestFramework):
    ...
    def run_test(self):
        ...
        output_pubkey = tweak_add_pubkey(tri.internal_pubkey, tri.tweak)[0]
        ...
        options = {'taproot': {output_pubkey.hex(): {'internal_key_index': 0, 'merkle_root': tri.merkle_root.hex()}}}
        ...
        options = {'taproot': {output_pubkey.hex(): {'internal_pubkey': internal_key.hex(), 'scripts': scripts}}}
