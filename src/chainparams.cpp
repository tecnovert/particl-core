...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000eb4efad39ca218f3d");
        consensus.defaultAssumeValid = uint256S("0x89de981a2cca262ae52ff5e69a0915c9083fb7cd4aba44e39f83c12a6b6602a9"); // 808059
 ...
 * Testnet (Particl v2)
 */
class CTestNetP2Params : public CChainParams {
public:
    CTestNetP2Params() {
        strNetworkID = CBaseChainParams::TESTNET_P2;
        consensus.signet_blocks = false;
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 210000;
        consensus.BIP34Height = 0;
...
std::unique_ptr<CChainParams> CreateChainParams(const ArgsManager& args, const std::string& chain)
{
    ...
    } else if (chain == CBaseChainParams::TESTNET_P2) {
        return std::unique_ptr<CChainParams>(new CTestNetP2Params());
    }
