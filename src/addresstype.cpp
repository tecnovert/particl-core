...
public:
    ...
    // Particl
    bool operator()(const CStealthAddress& dest) const { return true; }
    bool operator()(const CExtPubKey& dest) const { return true; }
    bool operator()(const CKeyID256& dest) const { return true; }
    bool operator()(const CScriptID256& dest) const { return true; }
};
} // namespace
