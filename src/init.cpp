...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-lookuptorcontrolhost", strprintf("Allow a hostname to be specified for the -torcontrol option (default: %d)", false), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
