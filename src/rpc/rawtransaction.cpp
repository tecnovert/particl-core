        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const PackageMempoolAcceptResult package_result = [&] {
        LOCK(::cs_main);
        if (txns.size() > 1) return ProcessNewPackage(chainstate, mempool, txns, /* test_accept */ true, ignore_locks);
        return PackageMempoolAcceptResult(txns[0]->GetWitnessHash(),
               AcceptToMemoryPool(chainstate, mempool, txns[0], /* bypass_limits */ false, /* test_accept*/ true, ignore_locks));
    }();
                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," Particl address if there is one"},
                                    }},
                                }},
