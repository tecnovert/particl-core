...
static RPCHelpMan mnemonicrpc()
{
    return RPCHelpMan{"mnemonic",
        ...
        "mnemonic decode \"password\" \"mnemonic\" ( bip44 legacy_french_bom )\n"
        "    Decode mnemonic\n"
        "    bip44, true|false, default true\n"
        "    legacy_french_bom, true|false, default false\n"
        "        Derive the key of a French mnemonic generated by a release which\n"
        "        included a byte order mark in the word \"abaisser\".\n"
    ...
    [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (mode == "decode") {
        ...
        bool legacy_french_bom = request.params.size() > 4 ? GetBool(request.params[4]) : false;
        ...
        if (0 != mnemonic::ToSeed(sMnemonic, sPassword, vSeed, legacy_french_bom)) {
            throw JSONRPCError(RPC_INTERNAL_ERROR, "mnemonic::ToSeed failed.");
        }
