...
BOOST_AUTO_TEST_CASE(test_FormatSubVersion)
{
    ...
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 9990000, std::vector<std::string>()),std::string("/Test:0.9.99.0/"));
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 9990000, comments),std::string("/Test:0.9.99.0(comment1)/"));
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 9990000, comments2),std::string("/Test:0.9.99.0(comment1; Comment2; .,_?@-; )/"));
}
