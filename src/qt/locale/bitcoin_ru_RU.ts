...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Это ваши Particl-адреса для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой монет.</translation>
    </message>
    <message>
        <source>These are your Particl addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши адреса Particl для получения платежей. Для создания новых адресов используйте кнопку "Создать новый адрес получения" на вкладке "Получение".
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введите адрес Particl (например, %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Отправляйте монеты на адрес Particl</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Проверка сообщений на предмет того, что они были подписаны указанными адресами Particl</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Запрос платежей (генерирует QR-коды и particl: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Загрузка частично подписанной транзакции Particl из буфера обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Покажите сообщение справки %1, чтобы получить список возможных опций командной строки Particl</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <extracomment>A substring of the tooltip.</extracomment>
        <translation type="unfinished">
            <numerusform>%n активное соединение(я) с сетью Particl.</numerusform>
            <numerusform>%n активное соединение(я) с сетью Particl.</numerusform>
            <numerusform>%n активное соединение(я) с сетью Particl.</numerusform>
        </translation>
    </message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введенный адрес "%1" не является действительным адресом Particl.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%1будет скачано и сохранит копию цепи блоков Particl.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически откройте порт клиента Particl на маршрутизаторе. Это работает, только если ваш маршрутизатор поддерживает UPnP и он включен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически откройте порт клиента Particl на маршрутизаторе. Это работает только в том случае, если ваш маршрутизатор поддерживает NAT-PMP и он включен. Внешний порт может быть произвольным.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключитесь к сети Particl через прокси-сервер SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключайтесь к сети Particl через отдельный прокси-сервер SOCKS5 для луковых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">'particl://' не является правильным URI. Вместо этого используйте 'particl:'.</translation>
    </message>
    <message>
...
Если вы получаете эту ошибку, вам следует попросить продавца предоставить URI, совместимый с BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">URI не может быть разобран! Это может быть вызвано недействительным адресом Particl или неправильно сформированными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Необязательное сообщение для прикрепления к платежному запросу, которое будет отображаться при открытии запроса. Примечание: Сообщение не будет отправлено вместе с платежом через сеть Particl.</translation>
    </message>
    <message>
...
Примечание: Поскольку плата рассчитывается на основе каждого байта, ставка платы "100 сатоши за кб" для транзакции размером 500 виртуальных байт (половина 1 кб) в конечном итоге даст плату всего в 50 сатоши.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: Недействительный адрес Particl</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Адрес Particl для отправки платежа</translation>
    </message>
    <message>
        <source>Paste address from clipboard</source>
        <translation type="unfinished">Вставить адрес из буфера обмена</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Сообщение, прикрепленное к particl: URI, которое будет сохранено вместе с транзакцией для справки. Примечание: Это сообщение не будет отправлено по сети Particl.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Адрес Particl для подписи сообщения</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation type="unfinished">Выберите ранее использовавшийся адрес</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Подпишите сообщение, чтобы доказать, что вы являетесь владельцем этого адреса Particl</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
    ...
    <message>
        ...
        <translation type="unfinished">Particl-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Проверьте сообщение, чтобы убедиться, что оно было подписано указанным Particl-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation type="unfinished">Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s поврежден. Попробуйте использовать инструмент кошелька particl-wallet для спасения или восстановить резервную копию.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка: Версия дампфайла не поддерживается. Эта версия particl-кошелька поддерживает только дампфайлы версии 1. Получен дампфайл с версией %s</translation>
    </message>
    <message>
